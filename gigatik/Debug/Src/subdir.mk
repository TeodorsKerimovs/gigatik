...
Src/%.o Src/%.su Src/%.cyclo: ../Src/%.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 '-DUART_BAUD_RATE = 9600' '-DLED_0_GPIOB_PIN = 2' '-DLED_1_GPIOB_PIN = 5' -DDEBUG -DSTM32F103RBTx -DSTM32 -DSTM32F1 -DNUCLEO_F103RB -DSTM32F103xB -c -I../Inc -I"/Users/teodors.kerimovs/STM32CubeIDE/workspace_1.14.0/gigatik/Inc/Drivers/CMSIS/Device/ST/STM32F1xx/Include" -I"/Users/teodors.kerimovs/STM32CubeIDE/workspace_1.14.0/gigatik/Inc/Drivers/CMSIS/Core/Include" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
